...
[NOTE]
Some sections of the original {MSTS} technical documents are also included here as reference material since some of these details exist no where else unless you have the original {MSTS} documentation and CDROMS.  These are now pretty outdated, and unobtainable to some people and are included here for reference only.
