...
You will see that we have renamed the default "user" location's name to be "FREIGHT" and changed the folder location it references and I also added an additional library folder for ENGINE related library objects.  This is just a personal preference and you can name these folders whatever you like.  You can also add additional folders to this list by clicking on the "+" symbol at the bottom right of the "Asset Libraries" window.
