...
Making use of a `COMMON` folder to store shared details across multiple bits of content.   This can also be about improving performance as well. Let's Say you are John Doe...

Within the `\trains` directory,

Add `\johndoe.common.` 

Here you can place items that are common among multiple models.


[NOTE]
If you closely examine Erick's NAVS releases, they follow a format like this.
