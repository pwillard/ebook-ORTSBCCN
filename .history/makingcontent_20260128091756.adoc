...
To export your model for using with {MSTS} or ORTS, Wayne Campbell created a very capable exporter add-on for {MSTS} format `.s` files.
...
* BitMap Tools: _Canva Affinity Studio_ (free), _Photoshop CS2_ (You can still get this for free from Adobe if you google for it) , _Paint.net_ (free), _PaintShop Pro_ (even version 7 still works), or download the latest version of _GIMP_ or _Krita_ for free.
...
The following section applies to Blender version 3.0 and later. Be aware that certain changes introduced in Blender 4.0 may affect the procedures described here, particularly those related to add-on installation.
...
== Installing Add-ons in Blender 4.3
...
For location, there are 4 general locations

* In sub-folder in the .wag or .eng folder.
* Directly in the .wag or .eng folder. (Could get messy)
