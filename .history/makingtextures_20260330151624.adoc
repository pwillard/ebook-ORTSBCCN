...
Yes, Blender can import DDS files directly. Blender has built-in support for reading and using DDS textures. However, the quality of the import and how you use the textures depends on the specific DDS file and your project's needs. You don't need any additional add-ons to import DDS files in Blender. Just like importing any other image format.
