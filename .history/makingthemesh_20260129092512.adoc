...
We will digress for a moment to share one of the reasons why using 3D CANVAS was so helpful in the initial stages of making a model.
...
.Exporter
****
You will want to download and install the "MSTS Exporter". https://github.com/pwillard/Blender_MSTS_ORTS_Exporter/releases/download/4.8.2/io_export_mstsexporter_4-8-2.zip

The Documentation is included in the ZIP file.  The documentation is also available separately at this location: https://github.com/pwillard/Blender_MSTS_ORTS_Exporter/releases/download/4.8.2/MstsExporterDocumentation.zip

NOTE: Version numbers may change as updates are made. Use the latest version available at https://github.com/pwillard/Blender_MSTS_ORTS_Exporter/releases/
