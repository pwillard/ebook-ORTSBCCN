...
.Author's Advice
----
Start with the option that is easiest for you to understand and then adjust as you go. Some developers are well-versed in Blender and can help you with the modeling, but keeping it simple will help you get started faster.  Maybe just start with a `Made for Open Rails` only project, for example.
----
...
[NOTE]
Using METRIC for measurements. It's the default measurement in Blender and {OR}.  It is realized that some people have become very attached to their Imperial units but Metric does make for worldwide compatibility and in the end it just ends up being easier if you stick with it. 
