...
| 8-bit grayscale image	| Color Mode: grayscale, Color Depth: 8-bit (1 channel x 28), Colors: 256, File Size: 24 kb (as GIF)
...
[NOTE]
Using Python.  There will be more on this in a later section of the documentation. This section is a quick guide to how I have been able to layout sections of a texture to create absolute placement and sizes for UV coordinates using code.
...
This section lists some of the "extra" tools and functions that are used to create textures.
