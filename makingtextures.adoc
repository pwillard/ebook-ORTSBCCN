...
Select Desired Faces by Seam - Pressing kdb:[L] - Faces Must Be Fully Enclosed by Seams for Selection to Work
...
When Baking occlusion, Here are some general tips:
