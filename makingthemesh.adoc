...
However, the image will only appear when viewing the scene in *Texture*
display mode. Because of this, it is not suitable for use as a background
reference drawing.
====
...
[NOTE]
Blender 3.6 LTS and newer versions once again support importing 3DS files.
