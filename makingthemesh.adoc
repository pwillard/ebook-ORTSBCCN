...
[NOTE]
Pete Willard has been working on Command Line tools that batch convert ACE files to PNG files.  You can then convert these to DDS format using the command line tools. (or you can use Microsoft "texconv.exe" to convert the files) You can find the tools at: https://github.com/pwillard/Ace2DDS
